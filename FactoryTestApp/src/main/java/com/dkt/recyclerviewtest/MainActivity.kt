...
import com.dkt.recyclerviewtest.holder.BaseViewHolder
...
class MainActivity : AppCompatActivity() {
    ...
    var dataList = mutableListOf<ICardModel>().apply { addAll(dataTemplate) }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        refresh_layout.setOnRefreshListener {
            dataList = mutableListOf<ICardModel>().apply { addAll(dataTemplate) }
            myAdapter.setItems(dataList)
